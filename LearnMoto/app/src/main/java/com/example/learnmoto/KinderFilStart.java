...
public class KinderFilStart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kinder_fil_start);
            ...
            public void onClick(View view) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(KinderFilStart.this, "Please Select an option", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestions();
                }
    ...
    private void checkAnswer() {
        ...
        if (qCounter < totalQuestions) {
            ...
            documentReference.update("filipinoScoreAct", engScore);
    ...
    private void incorrectDialog() {
        builder = new AlertDialog.Builder(KinderFilStart.this);
    ...
    private void addQuestions() {
        quizzesModelList.add(new QuizzesModel("Alin dito ang salitang Bulaklak? ", "Bulaklak", "Puno", "Aso", "Pusa", 1));
        quizzesModelList.add(new QuizzesModel("Ano ang kulay ng Rosas ", "Pula/Red", "Asul/Blue", "Kahel/Orange", "Dilaw/Yellow", 1));
        quizzesModelList.add(new QuizzesModel("Alin dito ang nagpapakita ng masipag? ", "Magkalat", "Matulog", "Tumulong maglinis", "Mag Cellphone", 3));
        quizzesModelList.add(new QuizzesModel("Alin dito ang salitang libro? ", "Libro", "Lapis", "Upuan", "Pinto", 1));
        quizzesModelList.add(new QuizzesModel("Alin dito ang tagalog na salita? ", "Lapis", "Notebook", "Chair", "Table", 1));
    }
