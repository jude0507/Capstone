...
public class ViewStory extends AppCompatActivity {
    ...
    String Story1, Story2, Story3, Story4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Stories.title1.equals("The lion and the mouse")){
            jtv.setText(Story1);
            TitleStory.setText(Stories.title1);
        }else if (Stories.title2.equals("The ant and the dove")){
            jtv.setText(Story2);
            TitleStory.setText(Stories.title2);
        }
    }
