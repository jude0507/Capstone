...
public class PreparatoryFilipinoWatch extends AppCompatActivity implements RecyclerViewInterface {
    ...
    String subject = "Preparatory Filipino";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_preparatory_filipino_watch);
        ...
        videoAdapter = new VideoAdapter(PreparatoryFilipinoWatch.this, videoNameArraylist, this);
    ...
    public void takeaquiz(View view){
        redirectActivity(this, PreparatoryFilipinoQuiz.class);
    }
