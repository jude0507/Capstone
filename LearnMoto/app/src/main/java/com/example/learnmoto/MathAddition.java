...
public class MathAddition extends AppCompatActivity {
    ...
    public void NextQuestion() {
        a = random.nextInt(6);
        b = random.nextInt(6);
//        textToSpeech.speak(QuestionTextView.toString(),TextToSpeech.QUEUE_ADD,null);
    ...
    private void Dialog() {
        builder = new AlertDialog.Builder(MathAddition.this);
//        final View view = getLayoutInflater().inflate(R.layout.dialog_model,null);
        builder.setView(R.layout.dialog_model).setIcon(R.drawable.great);
