package com.example.learnmoto.Preparatory.SibikaKultura;
...
public class PreparatorySibKulWatch extends AppCompatActivity implements RecyclerViewInterface {
    ...
    String subject = "Preparatory Sibika at Kultura";
    TextView subjectlevel;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_preparatory_sib_kul_watch);
        ...
        videoAdapter = new VideoAdapter(PreparatorySibKulWatch.this, videoNameArraylist, this);
    ...
    public void readme(View view){
        redirectActivity(this, PreparatorySibKulRead.class);
    }
    public void watchme(View view){
        recreate();
    }
    public void takeaquiz(View view){
        redirectActivity(this, PreparatorySibKulQuiz.class);
    }
