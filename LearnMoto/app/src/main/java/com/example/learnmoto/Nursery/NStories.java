...
import com.example.learnmoto.Adapter.NurseryStoriesAdapter;

import java.util.ArrayList;
import java.util.List;

public class NStories extends AppCompatActivity {
    ...
    NurseryStoriesAdapter storiesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storiesAdapter = new NurseryStoriesAdapter(this, storyTitles, storyImages);
