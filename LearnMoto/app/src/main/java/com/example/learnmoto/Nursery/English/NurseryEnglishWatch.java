...
public class NurseryEnglishWatch extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoAdapter = new VideoAdapter(NurseryEnglishWatch.this, videoNameArraylist, this);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(this, NurseryEngVideoView.class);
