...
public class AnimalsRead extends AppCompatActivity {

    DrawerLayout drawerLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_animals_read);
    ...
    public void watchme(View view){
        redirectActivity(this, AnimalsWatch.class);
    }
    public void takeaquiz(View view){
        redirectActivity(this, AnimalsQuiz.class);
    }
