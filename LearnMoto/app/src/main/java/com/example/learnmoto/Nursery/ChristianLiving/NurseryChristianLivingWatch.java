package com.example.learnmoto.Nursery.ChristianLiving;
...
public class NurseryChristianLivingWatch extends AppCompatActivity implements RecyclerViewInterface {
    ...
    String subject = "Nursery Christian Living";
    TextView subjectlevel;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nursery_christian_living_watch);
        ...
        videoAdapter = new VideoAdapter(NurseryChristianLivingWatch.this, videoNameArraylist, this);
    ...
    public void readme(View view){
        redirectActivity(this, NurseryChristianLivingRead.class);
    }
    public void watchme(View view){
        recreate();
    }
    public void takeaquiz(View view){
        redirectActivity(this, NurseryChristianLivingQuiz.class);
    }
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(this, NurseryCLVideoView.class);
