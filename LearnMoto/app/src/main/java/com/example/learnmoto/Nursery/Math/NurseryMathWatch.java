...
public class NurseryMathWatch extends AppCompatActivity implements RecyclerViewInterface {
    ...
    String subject = "Nursery Math";
    TextView subjectlevel;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nursery_math_watch);
        ...
        videoAdapter = new VideoAdapter(NurseryMathWatch.this, videoNameArraylist, this);
    ...
    public void readme(View view){
        redirectActivity(this, NurseryMathRead.class);
    }
    public void watchme(View view){
        recreate();
    }
    public void takeaquiz(View view){
        redirectActivity(this, NurseryMathQuiz.class);
    }
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(this, NurseryMathVideoView.class);
