...
public class NurseryChristianLivingQuiz extends AppCompatActivity {
    ...
    Button quizArrow;
   // public static String subjectName = "Nursery Christian Living";
    public static String subjectName = "Christian Living";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nursery_christian_living_quiz);
    ...
    public void watchme(View view){
        redirectActivity(this, NurseryChristianLivingWatch.class);
    }
