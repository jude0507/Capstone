...
public class KinderEnglishWatch extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoAdapter = new VideoAdapter(KinderEnglishWatch.this, videoNameArraylist, this);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(this, KinderEnglishVideoView.class);
