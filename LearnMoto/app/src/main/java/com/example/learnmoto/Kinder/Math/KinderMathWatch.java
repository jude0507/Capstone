...
public class KinderMathWatch extends AppCompatActivity implements RecyclerViewInterface {
    ...
    String subject = "Kinder Math";
    TextView subjectlevel;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kinder_math_watch);
        ...
        videoAdapter = new VideoAdapter(KinderMathWatch.this, videoNameArraylist, this);
    ...
    public void takeaquiz(View view){
        redirectActivity(this, KinderMathQuiz.class);
    }
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(this, KinderMathVideoView.class);
