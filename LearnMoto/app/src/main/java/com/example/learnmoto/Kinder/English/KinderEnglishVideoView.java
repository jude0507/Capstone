...
public class KinderEnglishVideoView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kinder_english_video_view);
    ...
    public void onBackPressed() {
        ...
        if (pressed == 1){
            ...
            startActivity(new Intent(this, KinderEnglishWatch.class));
