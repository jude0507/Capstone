...
public class KinderScienceWatch extends AppCompatActivity implements RecyclerViewInterface {
    ...
    String subject = "Kinder Science";
    TextView subjectlevel;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kinder_science_watch);
        ...
        videoAdapter = new VideoAdapter(KinderScienceWatch.this, videoNameArraylist, this);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(this, KinderSciVideoView.class);
