...
public class NurseryScienceWatch extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nursery_science_watch);
        ...
        videoAdapter = new VideoAdapter(NurseryScienceWatch.this, videoNameArraylist, this);
    ...
    public void takeaquiz(View view){
        redirectActivity(this, NurseryScienceQuiz.class);
    }
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(this, NurserySciVideoView.class);
